...
class _SharedPrefKullanimiState extends State<SharedPrefKullanimi> {
        ...
        child: Form(
            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: RadioListTile(value: true, groupValue: cinsiyet, onChanged: (secildi){
                ...
                Padding(
                  padding: const EdgeInsets.all(8.0),
                  child: RadioListTile(value: false, groupValue: cinsiyet, onChanged: (secildi){
  ...
  void _goster() {
    ...
    debugPrint("Okunan isim "+(mySharedPrefences as SharedPreferences).getString("myIsim")?? "NULLLL");
    debugPrint("Okunan id "+(mySharedPrefences as SharedPreferences).getInt("myId").toString() ?? "NULL");
    debugPrint("Cinsiyet erkek mi "+(mySharedPrefences as SharedPreferences).getBool("myCinsiyet").toString() ?? "NULLL");
